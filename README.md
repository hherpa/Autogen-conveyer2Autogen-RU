...
4. [Типизация агентов autogen](#Agent_type)
5. [Агент повышения точности](#boost_agent)
6. [Обмен универсальными агентами autogen](#trade_agent)
7. [Conveyer2Autogen](#Conveyer2Autogen)
8. [Conveyer2Autogen pipeline](#Conveyer2Autogen_pipeline)
9. [разбор пайплана Conveyer2Autogen](#R_Conveyer2Autogen)
10. [Ссылочная модель общения агентов](#link_model)
11. [Conveyer2Conveyer](#Conveyer2Conveyer)
12. [Результаты работы](#work_result)
...
Раз даже у нас получилось сделать агента универсального типа, что может повысить точность группового чата autogen, то почему бы самому autogen не реализовать платформу где пользователи могут предлогать своих универсальных агентов, а лучшие результаты будут выкладываться официально либо на самой платформе либо на странице github.
